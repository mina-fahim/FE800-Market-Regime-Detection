...
class Inflation_Model_Status(Enum):  # noqa: N801  # type: ignore[reportGeneralTypeIssues]
...
class Inflation_Model_Base(ABC):  # noqa: N801
    ...
    def __init__(self, name_model: str = "Inflation Model") -> None:
        ...
        self.m_status: Inflation_Model_Status = Inflation_Model_Status.NOT_FITTED  # type: ignore[reportAttributeAccessIssue]
    ...
    def is_fitted(self) -> bool:
        ...
        return self.m_status == Inflation_Model_Status.FITTED  # type: ignore[reportAttributeAccessIssue]
    ...
    def __repr__(self) -> str:
        return f"Inflation_Model_Base(name='{self.m_name_model}', status={self.m_status.value})"
